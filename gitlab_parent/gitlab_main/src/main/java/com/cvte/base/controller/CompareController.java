...
import com.cvte.base.pojo.VersionList;
...
public class CompareController {
    ...
    public Result enter(@PathVariable String repoName,
                        @RequestBody VersionList versionList){

        List<Version> versions = versionList.getVersionList();
        Version oldVersion = versions.get(0);
        Version newVersion = versions.get(1);
